...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            switch (parts[2])
            {
                case "standard": gradeBook = new StandardGradeBook(name, Convert.ToBoolean(parts[3])); break;
                case "ranked": gradeBook = new RankedGradeBook(name, Convert.ToBoolean(parts[3])); break;
                default:
